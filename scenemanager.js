class SceneManager {
	...
	loadLevel(level, transition, title) {
		...
		if (!this.transition && !this.title) {		
			...
			this.game.addEntity(new Barrel(this.game,1200,500-60))


			this.game.addEntity(new Spike(this.game,1100,690));
			this.game.addEntity(new Spring(this.game,1050,690));
			...
			this.game.addEntity(new Spike(this.game,15770+gap,690));
			this.game.addEntity(new Spike(this.game,15770+(gap*2),690));
			this.game.addEntity(new Spike(this.game,15770+(gap*3),690));
